...
const NavBar: React.FC<NavProps> = ({ currentUser }): JSX.Element => {
  return (
    <>
      <nav
        className="flex h-auto min-h-16 w-full items-center border-b border-black bg-white px-[5%] lg:min-h-18"
      >
        <div
          className="mx-auto flex size-full auto-cols-fr items-center justify-between gap-4 lg:grid lg:grid-cols-[0.375fr_1fr_0.375fr]"
        >
          ...
          <div className="flex min-h-16 items-center justify-end gap-x-4">
            ...
            >
              <div
                className="my-[3px] h-0.5 w-6 transform bg-black transition duration-300 ease-in-out lg:hidden"
              ></div>
              <div
                className="my-[3px] h-0.5 w-6 transform bg-black transition duration-300 ease-in-out lg:hidden"
              ></div>
